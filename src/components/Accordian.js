            ...
            <div className="card">
                ...
                <div className="card">
                    ...
                    <div id="collapseTen" className="collapse" aria-labelledby="headingTen" data-parent="#accordion">
                        <div className="card-body">
                            I believe that a financial advisor should be a financial professional and not a financial salesperson.  Although my previous experience is as a CPA and not selling securities or insurance products and, as unbelievable as it sounds, this background is not typical for those who call themselves financial advisors.  Unfortunately, this profession is dominated by financial salespeople.  My background is important because my priority is providing independent, objective financial advice that is always in the best interest of the client rather than attempting to sell the financial product that will result in the largest commission for me.
